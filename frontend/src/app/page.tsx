...
async function getData() {
  ...
  try {
    ...
    return { tours: t.items || [], countries: Array.isArray(c) ? c.slice(0, 12) : [], guides: Array.isArray(g) ? g : [] };
  } catch {
    ...
    <>
      ...
      <section className="relative overflow-hidden bg-forest text-white">
        <div className="section grid gap-10 py-20 lg:grid-cols-2">
          ...
          <img className="h-[480px] w-full rounded-[2rem] object-cover shadow-2xl" src="https://images.unsplash.com/photo-1516426122078-c23e76319801?auto=format&fit=crop&w=1200&q=80"/>
        </div>
      </section>
